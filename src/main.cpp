...
#if defined(NDEBUG)
# error "Gadsdencoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Gadsdencoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 25200; // 7 hours
