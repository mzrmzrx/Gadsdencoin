...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("GadsdencoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GadsdencoinMiner : ProcessBlock, block not accepted");
    }
...
{
    LogPrintf("GadsdencoinMiner started\n");
    ...
    try { while (true) {
        ...
        LogPrintf("Running GadsdencoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("GadsdencoinMiner terminated\n");
        throw;
    }
}
